...
function jump001(field, autoMove) {
    ...
    if (field.value.length >= field.maxLength) {
        ...
        if ((countBarcode == 1) && (endLoop == 0)) {
            ...
            let trakingNum = document.getElementById("trackingNumber").value.trim();
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    row_2_data_5.innerHTML = json_responsetn1.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn1.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn1.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn1.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn1.data[0].job_id;
        ...
        if ((countBarcode == 2) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn2.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn2.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn2.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn2.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn2.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 3) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn3.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn3.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn3.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn3.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn3.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 4) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn4.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn4.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn4.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn4.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn4.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 5) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn5.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn5.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn5.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn5.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn5.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 6) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn6.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn6.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn6.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn6.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn6.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 7) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn7.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn7.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn7.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn7.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn7.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 8) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn8.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn8.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn8.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn8.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn8.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 9) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn9.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn9.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn9.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn9.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn9.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 10) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn10.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn10.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn10.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn10.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn10.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 11) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn11.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn11.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn11.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn11.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn11.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 12) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn12.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn12.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn12.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn12.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn12.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 13) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn13.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn13.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn13.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn13.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn13.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 14) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn14.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn14.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn14.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn14.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn14.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 15) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn15.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn15.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn15.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn15.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn15.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 16) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn16.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn16.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn16.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn16.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn16.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 17) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn17.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn17.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn17.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn17.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn17.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 18) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn18.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn18.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn18.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn18.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn18.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 19) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn19.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn19.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn19.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn19.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn19.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
        ...
        if ((countBarcode == 20) && (endLoop == 0)) {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    let row_2_data_4 = document.createElement('td');
                    let row_2_data_5 = document.createElement('td');
                    row_2_data_5.innerHTML = json_responsetn20.data[0].customer_username;
                    let row_2_data_6 = document.createElement('td');
                    row_2_data_6.innerHTML = json_responsetn20.data[0].job_address;
                    let row_2_data_7 = document.createElement('td');
                    row_2_data_7.innerHTML = json_responsetn20.data[0].customer_phone;
                    let row_2_data_8 = document.createElement('td');
                    row_2_data_8.innerHTML = json_responsetn20.data[0].job_description;
                    let row_2_data_9 = document.createElement('td');
                    row_2_data_9.innerHTML = json_responsetn20.data[0].job_id;
                    let row_2_data_10 = document.createElement('td');
                    let row_2_data_11 = document.createElement('td');
                    let row_2_data_12 = document.createElement('td');
